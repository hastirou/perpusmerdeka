...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #3f5369;">
    <!-- Brand Logo -->
    <a href="/" class="brand-link">
      {{-- <img src="{{ asset('/images/thelogo.png')}}" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: 1"> --}}
      &nbsp;
      <span class="brand-text font-weight-light">PERPUS UNMER</span>
    </a>
