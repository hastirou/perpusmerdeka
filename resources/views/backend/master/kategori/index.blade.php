	...
	<div class="col-md-12">
		<div class="card">
			<div class="card-header" style="background-color: #3f5369; height:60px;">
				<h3 style="color:white;">Kategori</h3></div>
...
<div class="col-md-12">
	<div class="card">
		<div class="card-header" style="background-color: #3f5369; padding: 0.1% 0.1% 0.1% 0.1%;">
			<h5 align="center" style="color:white;">Tabel Data Kategori</h5>
		</div>
		<div class="card-title" style="background-color:white;">
		</div>
		<div class="card-body">
			<table class="table table-bordered table-hover" id="table1" name="table1" style="text-align:center;">
				<thead style="background-color: #262626; color:white;">
					<tr>
						<th style="width:40%;">Kode Kategori</th>
				...
				<tbody>	
					...
					<tr>
						...
						<td>
							<a href="{{ url('/admin/master/kategori/edit/'.$mk->KodeKategori)}}" class="btn btn-warning">Edit</a>
							&nbsp;
							<a href="{{ url('/admin/master/kategori/hapus/'.$mk->KodeKategori)}}" class="btn btn-danger">Hapus</a>
						</td>
					</tr>
					@endforeach
				</tbody>
