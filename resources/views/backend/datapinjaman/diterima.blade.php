		...
		<div class="card">
			...
			<div class="card-title" style="background-color:white;">
				<div style="padding-top:1%; padding-left:1%; padding-bottom:1%; padding-right:1%;">
                    ...
                    @endif 
					<a href="{{ url('/admin/datapinjaman/diterima/selesai')}}" class="btn btn-success">
						<i aria-hidden="true"></i>
						Data Pinjaman Selesai
					</a>
				</div>
			</div>
		</div>
...
<div class="col-md-12">
	<div class="card">
		<div class="card-header" style="background-color: #3f5369; padding: 0.1% 0.1% 0.1% 0.1%;">
			<h5 align="center" style="color:white;">Tabel Data Pinjaman (Diterima)</h5>
		</div>
		<div class="card-title" style="background-color:white;">
		</div>
		<div class="card-body">
				...
				<tbody>	
					...
					<tr>
						...
						<td>
							...
							<a href="{{ url('/admin/datapinjaman/diterima/selesai/'.$dp->KodePinjaman)}}" class="btn btn-success">Selesai</a>
						</td>
					</tr>
					@endforeach
				</tbody>
